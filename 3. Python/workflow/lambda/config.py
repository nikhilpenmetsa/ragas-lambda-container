...
KB_ID = "38BKVBCQXT"
APPLICATION_NAME = 'nikhil-app-2'

# Application Configuration
EXPERIMENT_ID = "nikhil-eval-experiment-2" # this can be your project name
EXPERIMENT_DESCRIPTION = "This is an example experiment2"
