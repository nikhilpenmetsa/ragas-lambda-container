...
class BedrockLogs:
    ...
    def __init__(self, delivery_stream_name: str = None, 
        ...
        if self.delivery_stream_name == 'local':
            ...
            print("Initializing Firehose client...")
            # boto3_session = boto3.Session(profile_name='hub-account')
            # self.firehose_client = boto3_session.client('firehose')
        ...
        def wrapper(func):
            def inner(*args, **kwargs):
                ...
                if self.experiment_id is None:
                    self.experiment_id = result['experiment_description']
                    print("Experiment ID is none:", self.experiment_id)
                print("Experiment ID - outside if condition:", self.experiment_id)
                ...
                print("additional_metadata:----", additional_metadata)
